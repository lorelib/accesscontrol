...
(
	...
	updateDate DATETIME COMMENT '更新日期',
	PRIMARY KEY (id),
	UNIQUE union_unique(companyId, productCode, resourceId)
)  COMMENT='访问控制：资源表';
...
(
	...
	updateDate DATETIME COMMENT '更新日期',
	PRIMARY KEY (id),
	UNIQUE union_unique(roleName, productCode, companyId)
)  COMMENT='访问控制：角色表';


CREATE TABLE ac_role_permission
(
	roleId INTEGER NOT NULL COMMENT '角色表主键',
	permId INTEGER NOT NULL COMMENT '权限表主键'
...
(
	...
	updateDate DATETIME COMMENT '更新日期',
	PRIMARY KEY (id),
	UNIQUE union_unique(userLoginId, productCode, companyId)
)  COMMENT='访问控制：用户表';


CREATE TABLE ac_user_role
(
	userId INTEGER NOT NULL COMMENT '用户表主键',
	roleId INTEGER NOT NULL COMMENT '角色表主键'
